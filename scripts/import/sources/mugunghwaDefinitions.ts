...
export const MUGUNGHWA_LINE_DEFINITIONS: LineDefinition[] = [
  ...
  { rawLabel: 'MG03', lineCode: 'MG-GYEONGBU', officialName: '무궁화호 경부선', displayName: '무궁화-경부선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['경부선'], sortOrder: 702 },

  // MG04 장항선 — 단일 계통
  { rawLabel: 'MG04', lineCode: 'MG-JANGHANG', officialName: '무궁화호 장항선', displayName: '무궁화-장항선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['장항선'], sortOrder: 703 },

  // MG05 전라선 — 단일 계통
  { rawLabel: 'MG05', lineCode: 'MG-JEOLLA', officialName: '무궁화호 전라선', displayName: '무궁화-전라선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['전라선'], sortOrder: 704 },
  ...
  // MG09 중앙선 — 단일 계통
  { rawLabel: 'MG09', lineCode: 'MG-JUNGANG', officialName: '무궁화호 중앙선', displayName: '무궁화-중앙선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['중앙선'], sortOrder: 708 },

  // MG10 태백선 — 단일 계통
  { rawLabel: 'MG10', lineCode: 'MG-TAEBAEK', officialName: '무궁화호 태백선', displayName: '무궁화-태백선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['태백선'], sortOrder: 709 },

  // MG11 영동선 — 단일 계통
  { rawLabel: 'MG11', lineCode: 'MG-YEONGDONG', officialName: '무궁화호 영동선', displayName: '무궁화-영동선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['영동선'], sortOrder: 710 },
  ...
  { rawLabel: 'MG13', lineCode: 'MG-DAEGUSEON', officialName: '무궁화호 대구선', displayName: '무궁화-대구선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['대구선'], sortOrder: 713 },
  ...
  // MG18 경북선 — 단일 계통
  { rawLabel: 'MG18', lineCode: 'MG-GYEONGBUK', officialName: '무궁화호 경북선', displayName: '무궁화-경북선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['경북선'], sortOrder: 717 },

  // MG19 교외선 — 단일 계통
  { rawLabel: 'MG19', lineCode: 'MG-GYOE', officialName: '무궁화호 교외선', displayName: '무궁화-교외선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['교외선'], sortOrder: 718 },
]
