 ...
 * (예: "무궁화-충북선"), 나머지 pattern들은 parentLineCode로 대표에 딸린 자식
 ...
 * "그룹명(구간)" 전체가 아니라 구간만 쓴다 — 어차피 "무궁화-충북선" 버튼을
 ...
 * 로 고쳤다).
 *
 * 노선명 접두어("무궁화-")는 유지한다 — 2026-09-15에 "무궁화호에서는 노선에
 * '무궁화-'가 필요없네. 단일 노선 시 토글 박스에서도 '00선'만 보이게"라는 요청으로
 * displayName에서 접두어를 뗐다가(확장 30), 곧바로 "노선선택 이름에서 '무궁화-'가
 * 빠졌네. 전체운행범위 탐색 시 햇갈릴 위험으로 롤백이 필요할 것 같아"라는 확인이
 * 와서 되돌렸다(확장 33) — "전체" 범위에서는 무궁화호 "경부선"이 KTX·ITX-새마을의
 * 경부 노선(및 1호선 "경부/장항선")과 한 화면에 섞여 뜨므로 접두어가 있어야 구분된다.
 * 다만 토글박스("이 노선의 역 보기" 패널)는 이미 "무궁화-경부선" 버튼을 고른 뒤라
 * 접두어를 반복할 필요가 없으니, 계통이 하나뿐인 평면 노선은 stationListLabel로
 * "경부선"만 보이게 한다(요청의 뒷부분은 그대로 유지 — stationListLabel은 패널에서만
 * 쓰고 "노선 선택" 버튼·환승 배지 등은 displayName을 그대로 쓴다). 다중 계통 그룹의
 * 대표는 여전히 자기 구간(예: "동대구-영주")을 보여준다.
 *
...
export const MUGUNGHWA_LINE_DEFINITIONS: LineDefinition[] = [
  ...
  { rawLabel: 'MG01', lineCode: 'MG-CHUNGBUK', officialName: '무궁화호 충북선(동대구-영주)', displayName: '무궁화-충북선', stationListLabel: '동대구-영주', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['충북선'], sortOrder: 700 },
  ...
  { rawLabel: 'MG03', lineCode: 'MG-GYEONGBU', officialName: '무궁화호 경부선', displayName: '무궁화-경부선', stationListLabel: '경부선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['경부선'], sortOrder: 702 },

  // MG04 장항선 — 단일 계통
  { rawLabel: 'MG04', lineCode: 'MG-JANGHANG', officialName: '무궁화호 장항선', displayName: '무궁화-장항선', stationListLabel: '장항선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['장항선'], sortOrder: 703 },

  // MG05 전라선 — 단일 계통
  { rawLabel: 'MG05', lineCode: 'MG-JEOLLA', officialName: '무궁화호 전라선', displayName: '무궁화-전라선', stationListLabel: '전라선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['전라선'], sortOrder: 704 },

  // MG06/07/08 호남선 — MG06(용산-광주)을 대표로 삼는다
  { rawLabel: 'MG06', lineCode: 'MG-HONAM', officialName: '무궁화호 호남선(용산-광주)', displayName: '무궁화-호남선', stationListLabel: '용산-광주', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['호남선'], sortOrder: 705 },
  ...
  // MG09 중앙선 — 단일 계통
  { rawLabel: 'MG09', lineCode: 'MG-JUNGANG', officialName: '무궁화호 중앙선', displayName: '무궁화-중앙선', stationListLabel: '중앙선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['중앙선'], sortOrder: 708 },

  // MG10 태백선 — 단일 계통
  { rawLabel: 'MG10', lineCode: 'MG-TAEBAEK', officialName: '무궁화호 태백선', displayName: '무궁화-태백선', stationListLabel: '태백선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['태백선'], sortOrder: 709 },

  // MG11 영동선 — 단일 계통
  { rawLabel: 'MG11', lineCode: 'MG-YEONGDONG', officialName: '무궁화호 영동선', displayName: '무궁화-영동선', stationListLabel: '영동선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['영동선'], sortOrder: 710 },
  ...
  { rawLabel: 'MG13', lineCode: 'MG-DAEGUSEON', officialName: '무궁화호 대구선', displayName: '무궁화-대구선', stationListLabel: '대구선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['대구선'], sortOrder: 713 },

  // MG15/16/17 경전선 — MG15(동대구-진주)를 대표로 삼는다
  { rawLabel: 'MG15', lineCode: 'MG-GYEONGJEON', officialName: '무궁화호 경전선(동대구-진주)', displayName: '무궁화-경전선', stationListLabel: '동대구-진주', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['경전선'], sortOrder: 714 },
  ...
  // MG18 경북선 — 단일 계통
  { rawLabel: 'MG18', lineCode: 'MG-GYEONGBUK', officialName: '무궁화호 경북선', displayName: '무궁화-경북선', stationListLabel: '경북선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['경북선'], sortOrder: 717 },

  // MG19 교외선 — 단일 계통
  { rawLabel: 'MG19', lineCode: 'MG-GYOE', officialName: '무궁화호 교외선', displayName: '무궁화-교외선', stationListLabel: '교외선', iconLabel: ICON_LABEL, lineNumber: null, operatorCode: 'KR', regionCode: MUGUNGHWA_REGION_CODE, trainServiceCode: 'MUGUNGHWA', aliases: ['교외선'], sortOrder: 718 },
]
